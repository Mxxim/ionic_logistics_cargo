...
define(function(){
  ...
  /*
   * 三级联动城市插件
   * 用法：<select-city selectvalue="citydata"></select-city>
   * Param:selectvalue属性绑定controller的值$scope.citydata
   * citydata结果为 json对象
   * {
   * 		Province: "北京市",
   City: "北京市",
   ...
   */
    ...
    //        scope.allProvince = dealCodeCity(items["0"]);
    //        scope.allCity = [];
    //        scope.allCounty = [];
    //        scope.select = {
    //          selectProvince: "",
    ...
    //        }
    //
    //        function dealCodeCity(jsonData) {
    //          var result = [];
    ...
    //          return result;
    //        };
    //        scope.$watch("select.selectProvince", function() {
    //          if (scope.select.selectProvince == "") {
    //            scope.allCity = [];
    //            scope.select.selectCity = "";
    //            scope.allCounty = [];
    //            scope.select.selectCounty = "";
    //            scope.resultData.Province = "";
    //            scope.resultData.City = "";
    //            scope.resultData.County = "";
    //          } else {
    //            var param = "0," + scope.select.selectProvince;
    //            scope.allCity = dealCodeCity(items[param]);
    //            scope.select.selectCity = scope.allCity[0].code;
    //            var paramcounty = "0," + scope.select.selectProvince + "," + scope.allCity[0].code;
    //            scope.allCounty = dealCodeCity(items[paramcounty]);
    //            scope.select.selectCounty = scope.allCounty[0].code;
    //
    //            scope.resultData.Province = items["0"][scope.select.selectProvince];
    //            scope.resultData.City = items[param][scope.allCity[0].code];
    //            scope.resultData.County = items[paramcounty][scope.allCounty[0].code];
    //          }
    //        });
    //        scope.$watch("select.selectCity", function() {
    //          if (scope.select.selectCity == "") {
    //            scope.allCounty = [];
    //            scope.select.selectCounty = "";
    //            scope.resultData.City = "";
    //            scope.resultData.County = "";
    //          } else {
    //            var param = "0," + scope.select.selectProvince + "," + scope.select.selectCity;
    //            scope.allCounty = dealCodeCity(items[param]);
    //
    //            scope.resultData.City = items["0," + scope.select.selectProvince][scope.select.selectCity];
    //            scope.resultData.County = items[param][scope.allCounty[0].code];
    //          }
    //        });
    //        scope.$watch("select.selectCounty", function() {
    //          if (scope.select.selectCounty == "") {
    //            scope.resultData.County = "";
    //          } else {
    //            var param = "0," + scope.select.selectProvince + "," + scope.select.selectCity;
    //            scope.resultData.County = items[param][scope.select.selectCounty];
    //          }
    //        });
    //      },
    //      scope: {
    ...
    //      },
    //      template: '<div>' +
    //      '<select id="loc_province" ng-model="select.selectProvince">' +
    //      '<option value="">-选择省份-</option>' +
    //      '<option value="{{item.code}}" ng-repeat="item in allProvince">{{item.city}}</option>' +
    //      '</select>' +
    //      '<select id="loc_city" ng-model="select.selectCity">' +
    //      '<option value="" ng-selected="allCity.length==0">-不限城市-</option>' +
    //      '<option value="{{item.code}}" ng-repeat="item in allCity" ng-selected="$index==0">{{item.city}}</option>' +
    //      '</select>' +
    //      '<select id="loc_s" ng-model="select.selectCounty">' +
    //      '<option value="" ng-selected="allCounty.length==0">-不限县/区-</option>' +
    //      '<option value="{{item.code}}" ng-repeat="item in allCounty" ng-selected="$index==0">{{item.city}}</option>' +
    //      '</select>' +
    //      '</div>'
    //    }
    //  }
    ...
    //      '<div class="sub_header_div" ng-class="{slide:on}">' +
    //      '<ion-content scroll="false" padding="true" class="sub_header_div_c c_one">' +
    //      '<ion-scroll class="sub_header_div_c_s" direction="y" scrollbar-y="true">' +
    //      '<ion-list class="b_list">' +
    //      //'<ion-item value="{{item.code}}" ng-repeat="item in allProvince">{{item.city}}</ion-item>' +
    //      '<ion-item>广州市</ion-item>' +
    //      '<ion-item>广州市</ion-item>' +
    //      '<ion-item>广州市</ion-item>' +
    //      '<ion-item>广州市</ion-item>' +
    //      '<ion-item>广州市</ion-item>' +
    ...
    //      '</ion-scroll>' +
    //      '</ion-content>' +
    //      '<ion-content scroll="false" padding="true" class="sub_header_div_c c_two">' +
    //      '<ion-scroll class="sub_header_div_c_s" direction="y" scrollbar-y="true">' +
    //      '<ion-list class="b_list">' +
    //      '<ion-item>广州市</ion-item>' +
    //      '</ion-list>' +
    //      '</ion-scroll>' +
    //      '</ion-content>' +
    //      '<ion-content scroll="false" padding="true" class="sub_header_div_c c_three">' +
    //      '<ion-scroll class="sub_header_div_c_s" direction="y" scrollbar-y="true">' +
    //      '<ion-list class="b_list">' +
    //      '<ion-item>潮阳区</ion-item>' +
    //      '</ion-list>' +
    //      '</ion-scroll>' +
    //      '</ion-content>' +
    //      '</div>',
